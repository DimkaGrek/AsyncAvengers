function t(t){return t&&t.__esModule?t.default:t}var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},r={},a=e.parcelRequired7c6;null==a&&((a=function(t){if(t in n)return n[t].exports;if(t in r){var e=r[t];delete r[t];var a={id:t,exports:{}};return n[t]=a,e.call(a.exports,a,a.exports),a.exports}var s=Error("Cannot find module '"+t+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(t,e){r[t]=e},e.parcelRequired7c6=a);var s=a.register;s("kyEFX",function(t,e){Object.defineProperty(t.exports,"register",{get:function(){return n},set:function(t){return n=t},enumerable:!0,configurable:!0});var n,r=new Map;n=function(t,e){for(var n=0;n<e.length-1;n+=2)r.set(e[n],{baseUrl:t,path:e[n+1]})}}),s("kBiqv",function(t,e){t.exports=new URL("icons.b5315233.svg",import.meta.url).toString()}),a("kyEFX").register(new URL("",import.meta.url).toString(),JSON.parse('["d3pfZ","cart.d937bcba.js","hm5VY","icons.b5315233.svg","1kkTF","cart.fb314f43.css","eBb1I","index.78bb341e.js","1kkTF","cart.fb314f43.css","14klr","index.runtime.360d4df5.js"]'));var o=a("9OeKo");a("bUb57");var i=a("8O1yB"),c=a("6M5dt"),l=a("kBiqv");a("epHO8");var d=a("04jNI"),u=a("bfxWz");const p={itemsList:document.querySelector(".js-items-list"),fullCart:document.querySelector(".js-container"),emptyCart:document.querySelector(".js-empty-cart"),quantityHeaderSpan:document.querySelectorAll(".js-cart-quantity"),quantityTitle:document.querySelector(".js-quantity-span"),deleteAllButton:document.querySelector(".js-delete-all-btn"),totalSpan:document.querySelector(".js-total-price"),form:document.querySelector(".js-form-checkout")};let m=[];async function f(t){if(t.preventDefault(),h(b("CART")))return;(0,d.spinnerPlay)();let e="";new FormData(t.target).forEach(t=>{e=t});let n={};n.products=b("CART"),n.email=e;try{await (0,c.default).createOrder(n),(0,u.openModalSuccess)(),g("CART",[]),m=[],p.form.reset(),h(m)}catch(t){400===t.response.status?(0,u.openModalError)("Incorrect email","The email must be in format: johnsmith125@gmail.com"):(0,u.openModalError)("Server Issue","We're sorry, but it seems there's an issue with our server. Please try again later.")}finally{(0,d.spinnerStop)()}}async function y(e){(0,d.spinnerPlay)();try{if(!m)return;let n=e.map(async t=>await (0,c.default).getProductById(t.productId)),r=await Promise.all(n),a=r.map(({name:n,category:r,size:a,img:s,price:o,_id:i,is10PercentOff:c},d)=>`<li class="item-list" data-id="${i}">
       ...
       ${function(e){let n=`<svg class="cart-product-discount-icon" width="35" height="35">
          ...
          </li>`).join("");p.itemsList.innerHTML=a;let s=e.reduce((t,e)=>{let n=r.find(t=>t._id===e.productId);return n?t+n.price*e.amount:t},0).toFixed(2);p.totalSpan.textContent=`$${s}`,new i.default(p.itemsList,{autoHide:!1})}catch(t){p.fullCart.classList.add("is-hidden"),p.emptyCart.classList.remove("is-hidden"),(0,u.openModalError)("Server Issue","We're sorry, but it seems there's an issue with our server. Please try again later.")}finally{(0,d.spinnerStop)()}}function h(t){return t?.length?(p.emptyCart.classList.add("is-hidden"),p.fullCart.classList.remove("is-hidden"),!1):(p.fullCart.classList.add("is-hidden"),p.emptyCart.classList.remove("is-hidden"),p.quantityTitle.textContent="0",p.quantityHeaderSpan.forEach(t=>t.textContent="0"),window.scroll({top:0,behavior:"smooth"}),!0)}function g(t,e){try{let n=JSON.stringify(e);localStorage.setItem(t,n)}catch(t){console.error("Set state error: ",t.message)}}function b(t){try{let e=localStorage.getItem(t);return null===e?void 0:JSON.parse(e)}catch(t){console.error("Get state error: ",t.message)}}h(m=b("CART"))||(p.quantityTitle.textContent=`${m.length}`,p.quantityHeaderSpan.forEach(t=>t.textContent=`${m.length}`),y(m),p.deleteAllButton.addEventListener("click",function(){p.itemsList.classList.add("scale-down-center"),setTimeout(()=>{g("CART",[]),h(m=[]),(0,d.spinnerStop)()},500)}),p.itemsList.addEventListener("click",async t=>{if("UL"===t.target.nodeName)return;"delete"===t.target.dataset.action&&function(t){let e=t.target.closest("LI"),n=e.dataset.id,r=b("CART").filter(t=>t.productId!==n);e.classList.add("slide-top"),setTimeout(()=>{e.remove();let t=0;p.allPricesofProducts=document.querySelectorAll(".js-cart-product-price"),p.allAmountOfProducts=document.querySelectorAll(".js-amount-span"),t=r.reduce((t,e,n)=>t+Number(p.allPricesofProducts[n].textContent.replace("$",""))*Number(p.allAmountOfProducts[n].textContent),0),p.quantityTitle.textContent=`${r.length}`,p.quantityHeaderSpan.forEach(t=>t.textContent=`${r.length}`),p.totalSpan.textContent=`$${t.toFixed(2)}`,g("CART",r),h(r)},500)}(t);let e=t.target.dataset.action;("increment"===e||"decrement"===e)&&function(t,e){if(h(b("CART")))return;let n=Number(t.target.closest(".js-border-container").previousElementSibling.lastElementChild.textContent.replace("$","")),r=t.target.closest("SPAN").firstElementChild.nextElementSibling,a=Number(r.textContent),s=t.target.closest("LI").dataset.id;if("decrement"===e){if(1===a)return;a-=1,p.totalSpan.textContent="$"+(Number(p.totalSpan.textContent.replace("$",""))-n).toFixed(2)}"increment"===e&&(a+=1,p.totalSpan.textContent="$"+(Number(p.totalSpan.textContent.replace("$",""))+n).toFixed(2)),r.textContent=a;let o=b("CART"),i=o.findIndex(t=>t.productId===s);o[i].amount=a,g("CART",o)}(t,e)}),p.form.addEventListener("submit",f));const v=document.querySelector(".js-scroll-up-btn");document.addEventListener("scroll",t(o)(()=>{if(window.scrollY>200)return v.classList.add("show");v.classList.remove("show")},500)),v.addEventListener("click",()=>{window.scroll({top:0,behavior:"smooth"})});
//# sourceMappingURL=cart.d937bcba.js.map
